...
public class EditTextWithClear extends EditText {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.EditTextWithClear);

        switch (typedArray.getInteger(R.styleable.EditTextWithClear_clearButtonMode, 0)) {
            case 1:
        ...
        int clearButton = typedArray.getResourceId(R.styleable.EditTextWithClear_clearButtonDrawable, android.R.drawable.ic_delete);
        typedArray.recycle();

        //按钮的图片
        mClearButton = ((BitmapDrawable) ResourcesCompat.getDrawable(getResources(), clearButton, context.getTheme())).getBitmap();
